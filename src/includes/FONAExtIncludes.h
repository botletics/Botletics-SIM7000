...
#ifndef BOTLETICS_MODEM_LIBRARY_SRC_INCLUDES_FONAEXTINCLUDES_H_
#define BOTLETICS_MODEM_LIBRARY_SRC_INCLUDES_FONAEXTINCLUDES_H_
...
#endif /* BOTLETICS_MODEM_LIBRARY_SRC_INCLUDES_FONAEXTINCLUDES_H_ */
